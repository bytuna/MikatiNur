...
object AppConfig {
    ...
    val history = listOf(
        VersionHistory(
            ...
            versionCode = 6,
            date = "2026-05-23",
            description = "Kıble ekranı başlığı ve navigasyon yapısı güncellendi, harita özellikleri temizlendi.",
            developer = "ByTuna"
        ),
        VersionHistory(
            versionName = "1.1.2",
            versionCode = 5,
            date = "2026-05-22",
            description = "İndirme ve güncelleme sunucusu mikatinur.com.tr olarak güncellendi.",
            developer = "ByTuna"
        ),
        VersionHistory(
            versionName = "1.1.1",
